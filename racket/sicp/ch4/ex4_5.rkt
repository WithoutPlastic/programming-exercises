...
(define [alt-cond-clauses? clause]
  [and [memq '=> clause] [not [pair? (alt-clause-proc clause)]]])
(define [make-alt-clause predicate proc] (list predicate '=> proc))
(define [alt-clause-predicate alt-clause] (car alt-clause))
(define [alt-clause-proc alt-clause] (caddr alt-clause))
...
(define [expand-clauses clauses]
  (define [expand remaining-clauses]
    (let* ([first-clause (car clauses)]
      ...
      (if [alt-cond-clauses? first-clause]
        (let ([first-predicate (alt-clause-predicate first-clause)]
              [first-proc (alt-clause-proc first-clause)])
          (make-if-expr first-predicate
                        (list proc first-predicate)
                        (expand rest-clauses)))
        (let ([first-predicate (clause-predicate first-clause)]
