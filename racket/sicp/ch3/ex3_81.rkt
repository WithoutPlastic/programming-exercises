...
(define generate-symbol-stream
  (cons-stream 'generate (lambda [] generate-symbol-stream)))
(define full-generate-stream
  (convert-random generate-symbol-stream))
(define interleave-generate-stream
  (convert-random 
    (cons-stream 'generate
    (lambda [] (cons-stream 'generate
    (lambda [] (cons-stream 'generate
    (lambda [] (cons-stream 'generate
    (lambda [] (cons-stream 10010
    (lambda [] (cons-stream 'generate
    (lambda [] (cons-stream 'generate
    (lambda [] (cons-stream 'generate
    (lambda [] full-generate-stream))))))))))))))))))

(stream-ref full-generate-stream 0)
(stream-ref full-generate-stream 1)
(stream-ref full-generate-stream 2)
(stream-ref full-generate-stream 3)
(stream-ref full-generate-stream 4)
(stream-ref full-generate-stream 5)
(stream-ref full-generate-stream 6)
(stream-ref full-generate-stream 7)
(stream-ref full-generate-stream 8)
(stream-ref full-generate-stream 9)
(stream-ref full-generate-stream 10)
(stream-ref full-generate-stream 11)

(stream-ref interleave-generate-stream 0)
(stream-ref interleave-generate-stream 1)
(stream-ref interleave-generate-stream 2)
(stream-ref interleave-generate-stream 3)
(stream-ref interleave-generate-stream 4)
(stream-ref interleave-generate-stream 5)
(stream-ref interleave-generate-stream 6)
(stream-ref interleave-generate-stream 7)
(stream-ref interleave-generate-stream 8)
(stream-ref interleave-generate-stream 9)
(stream-ref interleave-generate-stream 10)
(stream-ref interleave-generate-stream 11)
