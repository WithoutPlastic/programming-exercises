...
;Answer:The last solution's main overhead come from recursively called
;sqrt-stream. Unlike the previous solution, the sqrt-stream is not the same
;during whole computing procedure. If memo-proc is removed, the overhead of two
;is the same.
