...
(define ramanujans-with-weight
  (stream-map (lambda [pair] (cons pair (cube-sum-weight pair)))
              ramanujans))
(stream-ref ramanujans-with-weight 0)
(stream-ref ramanujans-with-weight 1)
(stream-ref ramanujans-with-weight 2)
(stream-ref ramanujans-with-weight 3)
(stream-ref ramanujans-with-weight 4)
(stream-ref ramanujans-with-weight 5)
(stream-ref ramanujans-with-weight 6)
(stream-ref ramanujans-with-weight 7)
(stream-ref ramanujans-with-weight 8)
